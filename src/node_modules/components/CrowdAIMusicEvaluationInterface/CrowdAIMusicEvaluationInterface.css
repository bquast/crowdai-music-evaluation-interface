...
.crowdai_music_challenge_btns {
  ...
  font-weight: 700;
  outline: 0; }
  .crowdai_music_challenge_btns:hover {
    color: #fff;
    outline: 0; }
  .crowdai_music_challenge_btns:disabled {
    color: #595E72;
    border: 2px solid #595E72;
    opacity: 0.3;
    outline: 0;
    cursor: not-allowed; }
  .crowdai_music_challenge_btns:hover:enabled {
    box-shadow: 0 0 80px 80px #D95D55 inset; }
...
.controlsWrapper {
  padding: 10px;
  border: 1px solid #D95D55;
  border-radius: 5px;
  margin-bottom: 5px; }

.controlsWrapper_active {
  border: 3px solid #D95D55;
  border-radius: 6px; }
...
.SoundOffButton {
  ...
  .SoundOffButton.isEnabled {
    ...
    .SoundOffButton.isEnabled:active {
      border-color: rgba(153, 53, 47, 0.5); }
